	   ...
	   public static void main(String[] args) throws Exception { 
		   ...
		   bt.inOrder(); System.out.println();
		    ...
		    public void inOrderWithoutRecursion() { 
		    	Stack nodes = new Stack<>(); TreeNode current = root; 
		    ...
		    public static BinaryTree create() { 
		    	...
		    	TreeNode root = new TreeNode("4"); tree.root = root; tree.root.left = new TreeNode("2"); 
		    	tree.root.left.left = new TreeNode("1"); tree.root.left.right = new TreeNode("3");
		    	tree.root.right = new TreeNode("5"); tree.root.right.right = new TreeNode("6"); return tree; 
		    	}
